        ...
        {tab === 'register' && role === 'teacher' && (
          <>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, padding: '10px 12px', background: 'rgba(108,99,255,0.08)', border: '1px solid rgba(108,99,255,0.2)', borderRadius: 10, fontSize: 12, color: 'var(--text2)' }}>
              ...
              <span>Teacher registration requires an <strong style={{ color: 'var(--accent2)' }}>invite code</strong> from your institution admin.</span>
            </div>
            <div className="form-group">
              ...
              <div style={{ position: 'relative' }}>
                <input className="form-input" type={showCode ? 'text' : 'password'}
                  ...
                  style={{ paddingRight: 44, letterSpacing: 2, fontWeight: 600 }}
                  onKeyDown={e => e.key === 'Enter' && handleSubmit()} />
